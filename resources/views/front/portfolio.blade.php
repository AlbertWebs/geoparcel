...
<html lang="en-US">
   ...
   <head>
      ...
      <link media="all" href="{{asset('geopoint/wp-content/cache/autoptimize/css/autoptimize_32e1c5f4cafffb887fb0cf4ad78c96ff.css')}}" rel="stylesheet" />
      <title>Portfolio - Geoparcel</title>
   ...
   <body class="page-template page-template-template-projects page-template-template-projects-php page page-id-5649 wp-embed-responsive wp-featherlight-captions elementor-default elementor-kit-7">
         ...
         <div class="wrapper p-border">
            ...
            <div id="core">
               <div class="tmnf_container">
                  ...
                  <div class="clearfix"></div>
                  <div class="projects_page projects_wrap tmnf_modern_style">
                     <div class="item item_placeholder tmnf_column tmnf_column_6 "></div>
            ...
            <div id="footop" class="footop ">
               <img class="tranz tmnf_hero_image" src="{{asset('geopoint/wp-content/uploads/2022/03/12175.jpg')}}" alt="Park Aerial Survey"/>
               <div class="tmnf_container">
                  <div class="tmnf_column tmnf_column_12">
    ...
    <script defer src="{{asset('geopoint/wp-content/cache/autoptimize/js/autoptimize_3252a0d554e9ab9c021f11877d07c65f.js')}}"></script>
