       ...
       <div class="tmnf_container">
          ...
          <div class="tmnf_column tmnf_column_7">
             <ul class="tmnf_social_icons tranz">
                <li class="tmnf_twitter"><a style="color:#ffffff" class="mk-social-twitter-alt" href="https://twitter.com/geoparcel"><i class="fab fa-twitter"></i><span style="color:#ffffff">Twitter</span></a></li>
