...
<html lang="en-US">
   ...
   <head>
    ...
    <link rel='stylesheet' id='elementor-post-5175-css' href="{{asset('geopoint/wp-content/cache/autoptimize/css/autoptimize_single_14bcc914c1ca32365ad47517c098fce96cd2.css')}}" type='text/css' media='all' />
      ...
      <link rel="apple-touch-icon" href="{{asset('geopoint/wp-content/uploads/2022/03/cropped-006-isobars-180x180.png')}}" />
   ...
   <body class="home page-template page-template-elementor_header_footer page page-id-4079 wp-embed-responsive wp-featherlight-captions elementor-default elementor-template-full-width elementor-kit-7 elementor-page elementor-page-4079">
      ...
      <div class="wrapper_main tmnf_width_normal header_fullwidth head_default upper image_css_none site_offset_enabled tmnf-sidebar-active tmnf-sidebar-flyoff-fix ">
         ...
         <div class="wrapper p-border">
            ...
            <div id="footop" class="footop ">
               <img class="tranz tmnf_hero_image" src="{{asset('geopoint/wp-content/uploads/2022/03/12175.jpg')}}" alt="Home"/>
