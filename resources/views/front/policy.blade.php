    ...
    <div class="wrapper_main tmnf_width_normal header_fullwidth head_default upper image_css_none site_offset_enabled tmnf-sidebar-active tmnf-sidebar-flyoff-fix ">
      ...
      <div class="wrapper p-border">
        ...
        <ul>
            ...
            <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Geoparcel Surveys Limited, Namgoi Road, off Eldoret-Kitale Rd, Kitale.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Geoparcel Surveys Limited, accessible from <a href="https://www.geoparcelsurveys.com" target="_blank">https://www.geoparcelsurveys.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>
            <p>By email: hello@geoparcelsurveys.com</p>
            </li>
            <li>
            <p>By visiting this page on our website: <a href="http://geoparcelsurveys.com//contact-us" target="_blank">http://geoparcelsurveys.com//contact-us</a></p>
            </li>
        </ul>
                        <p></p>
